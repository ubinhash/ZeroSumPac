...
// //TODO: implement rob done, need testing!! error
...
// //END GAME can be called externally
...
//     }
//     function setRewardontract(address _contract) external onlyOwner {
...
//         require(hasplayer[maze][x][y]==0); //You can move direactly on top another person
...
//         require(players[playerid].shieldExpireTime  + shieldhours*3600<= block.timestamp+ config[ConfigKey.MAX_SHIELD_INTERVAL], "You can only be shielded for a max period of time");
//         require(shieldhours*3600<=config[ConfigKey.MAX_SHIELD_INTERVAL],"No");
